...
class pyfreefem:
    ...
    def __init__(self, freefem_binary=None, output_encoding='utf-8'):
    ...
    def execute_file(self, path):
        ...
        return {'output': output.decode(self.output_encoding), 'graphics': graphics}